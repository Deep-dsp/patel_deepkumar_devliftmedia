        ...
        <div className="explore-category row">
            ...
            <div className="card rootre" style={cardBackgroundStyle}>
              <div className="card-body mt-4">
                <img
                  ...
                  src="https://img.icons8.com/fluent/50/000000/rebalance-portfolio.png"
          ...
          <div className="col-md-2">
            <div className="card" style={cardBackgroundStyle}>
              <div className="card-body mt-4">
                <img
                  src="https://img.icons8.com/ultraviolet/50/000000/customer-support.png"
          ...
          <div className="col-md-2">
            <div className="card" style={cardBackgroundStyle}>
              <div className="card-body mt-4">
                <img
                  src="https://img.icons8.com/cute-clipart/50/000000/design.png"
                  alt="Design Icon"
                />
          ...
          <div className="col-md-2">
            <div className="card" style={cardBackgroundStyle}>
              <div className="card-body mt-4">
                <img
                  src="https://img.icons8.com/cotton/50/000000/developer.png"
          ...
          <div className="col-md-2">
            <div className="card" style={cardBackgroundStyle}>
              <div className="card-body mt-4">
                <img
                  src="https://img.icons8.com/plasticine/50/000000/fund-accounting.png"
                  alt="Finance Icon"
                />
          ...
          <div className="col-md-2">
            <div className="card" style={cardBackgroundStyle}>
              <div className="card-body mt-4">
                <img
                  src="https://img.icons8.com/cotton/50/000000/conference-background-selected.png"
                  alt="HR Icon"
                />
                <p className="card-text">
                  Human
          ...
          <div className="col-md-2">
            <div className="card" style={cardBackgroundStyle}>
              <div className="card-body mt-4">
                <img
                  src="https://img.icons8.com/cotton/50/000000/define-location--v2.png"
                  alt="Mearketing and communication Icon"
                />
          ...
          <div className="col-md-2">
            <div className="card" style={cardBackgroundStyle}>
              <div className="card-body mt-4">
                <img
                  src="https://img.icons8.com/dusk/50/000000/folder-tree.png"
          ...
          <div className="col-md-2">
            <div className="card" style={cardBackgroundStyle}>
              <div className="card-body mt-4">
                <img
                  src="https://img.icons8.com/nolan/50/speech-bubble-with-dots.png"
                  alt="Sales Icon"
                />
